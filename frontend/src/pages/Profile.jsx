...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-white flex flex-col selection:bg-primary-500 selection:text-white transition-colors duration-300">
      {/* Header Bar */}
      <header className="max-w-4xl mx-auto w-full px-6 py-4 flex items-center justify-between border-b border-slate-200 dark:border-slate-900 bg-white/85 dark:bg-slate-950/85 sticky top-0 backdrop-blur z-30 transition-colors duration-300">
        <button
          onClick={() => navigate('/dashboard')}
          className="flex items-center gap-2 text-xs font-semibold text-slate-400 hover:text-slate-800 dark:hover:text-white transition"
        >
          <ArrowLeft className="w-4 h-4" />
          Back to Dashboard
        </button>
        <span className="text-sm font-semibold tracking-wider uppercase text-slate-400 dark:text-slate-500">My Account</span>
      </header>
        ...
        <div className="glass-premium p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl relative animate-fade-in bg-white/40 dark:bg-slate-900/40 transition-colors">
          ...
          {!isEditing ? (
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
              {/* Avatar display */}
              <div className="w-24 h-24 bg-slate-100 dark:bg-slate-900 rounded-2xl overflow-hidden border-2 border-slate-200 dark:border-slate-800 shadow-lg relative shrink-0">
                <img
            ...
            <form onSubmit={handleSave} className="space-y-6">
              ...
              <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                {/* Image Edit & Upload */}
                <div className="relative group w-24 h-24 bg-slate-100 dark:bg-slate-900 rounded-2xl overflow-hidden border-2 border-slate-200 dark:border-slate-850 hover:border-slate-300 dark:hover:border-slate-700 shadow-lg shrink-0">
                  <img
