...
const Notifications = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex flex-col selection:bg-primary-500 selection:text-white">
      {/* Header Bar */}
      <header className="max-w-4xl mx-auto w-full px-6 py-4 flex items-center justify-between border-b border-slate-900 bg-slate-950/85 sticky top-0 backdrop-blur z-30">
        <button
        ...
        <span className="text-sm font-semibold tracking-wider uppercase text-slate-500">Notifications Inbox</span>
      </header>

      {/* Main Inbox */}
      <main className="flex-1 max-w-4xl mx-auto w-full px-6 py-10">
        <div className="glass-premium p-8 rounded-3xl border border-slate-800 min-h-[450px] shadow-2xl flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between pb-4 border-b border-slate-900">
              <h2 className="text-sm font-semibold tracking-wider text-slate-200 uppercase flex items-center gap-2">
                <Bell className="w-4.5 h-4.5 text-primary-400 animate-swing" />
            ...
            {loading ? (
              ...
              <div className="py-20 flex flex-col items-center justify-center text-slate-500 text-center space-y-3">
                <div className="p-3 bg-slate-900 rounded-2xl text-slate-700">
                  <BellOff className="w-8 h-8" />
                </div>
                <p className="text-xs">Your inbox is completely clear.</p>
                <p className="text-[10px] text-slate-600 max-w-xs">When users invite you to meetings or share files, details appear here.</p>
              </div>
            ) : (
                  ...
                  return (
                    <div
                      ...
                      className={`py-4 flex items-center justify-between gap-4 px-2 rounded-xl transition ${
                        notif.isRead ? 'opacity-60' : 'bg-slate-900/10'
                      }`}
                    >
                      <div className="flex items-center gap-3.5">
                        ...
                        <div className="relative shrink-0">
                          ...
                          <span className="absolute -bottom-1 -right-1 p-1 bg-slate-950 border border-slate-800 rounded-full flex items-center justify-center scale-90">
                            {getIcon(notif.type)}
                          </span>
                        </div>
                        ...
                        <div className="flex flex-col">
                          <p className="text-xs text-slate-200 font-medium leading-normal max-w-md">
                            {notif.message}
                          </p>
          ...
          <div className="text-[10px] text-slate-600 pt-6 border-t border-slate-900 text-center">
